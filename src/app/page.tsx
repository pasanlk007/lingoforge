              ...
              <Card className="w-full max-w-sm border-2 border-transparent">
                ...
                <CardContent className="flex flex-col gap-6 text-center">
                  ...
                  <ul className="space-y-3 text-left">
                    <li className="flex items-center gap-2">✓ All 3 Learning Paths</li>
                    <li className="flex items-center gap-2">✓ All 48 weeks of content</li>
                    <li className="flex items-center gap-2">✓ Native audio pronunciation</li>
                    <li className="flex items-center gap-2">✓ AI Guide for questions</li>
                  </ul>
