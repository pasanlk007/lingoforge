...
export const translations = {
  ...
  Sinhala: {
    ...
    features: {
      ai: { title: "advance ai", desc: "ඔබ වෙනුවෙන් ජනනය කරන ලද පාඩම්" },
    ...
    lifetimePlan: {
      ...
      price_lkr: "LKR 29,700",
      feat1: "Survival lessons",
      feat2: "Basic numbers + alphabet",
      feat3: "Lingoforge pro lesson",
      feat4: "Practic pharases + Quiz",
    ...
    dashboard: {
      ...
      language: "භාෂාව",
      continueJourney: "keep improving",
  ...
  Hindi: {
    scenario: {
      ...
      generatingStatus: "Building plan...",
      errorStatus: "Couldn't generate",
      buildingPlanTitle: "lingoforge is building your plan...",
      buildingPlanSubtitle: "This takes a few seconds.",
      buildFailedTitle: "Couldn't generate the plan",
      tryAgainButton: "Try again",
      slowGenerationTitle: "This is taking longer than usual",
  ...
  Urdu: {
    ...
    dashboard: {
      ...
      reminders: {
        ...
        description: "اپنی تعلیم کے साथ ٹریک پر رہنے کے لئے روزانہ اطلاع مرتب کریں۔",
      ...
      proBundle: {
        ...
        items: {
          ...
          tutors: { title: "দින 30 ව්‍යුහගත", desc: "පාඩම් සිතියම" }
        }
      }
    },
    notifications: {
    ...
    ui: {
      ...
      upgradeToUnlock: "انلاک کرنے के لیے اپ گریڈ کریں۔",
      // lesson page errors
      ...
      errorDayNotFound: "فائل '{lessonPath}' میں دن {day} का ڈیٹا نہیں ملا। یقینی بنائیں کہ JSON فائل में 'days' سرنی میں اس دن کے لئے ایک اندراج موجود ہے۔",
      ...
      contentNotAvailableDesc: "یہ سبق ابھی تک نہیں بنایا گیا ہے۔ آپ `public/lessons` ڈائرکٹری میں سبق की फाइल बना सकते हैं। ہدایات کے لئے براہ کرم `docs/lesson-generation-guide.md` देखیں۔",
      // lesson client page
      ...
      dayComplete: "دن مکمل!",
      earnedXP: "آپ نے {xp} XP اور {streak_bonus} का اسٹریک بونس حاصل کیا ہے۔",
  ...
  Bengali: {
    ...
    ui: {
      ...
      errorWeekNotFound: "{path} পথের সপ্তাহ {week} এর জন্য পাঠের বিষয়বস্তু বিদ্যমান নেই। অনুগ্রহ করে 'public{lessonPath}' এ ফাইলটি তৈরি করুন।",
      errorDayNotFound: "ফাইল '{lessonPath}' এ দিন {day} এর জন্য ডেটা খুঁজে পাওয়া যায়নি। নিশ্চিত করুন যে JSON ফাইলের 'days' অ্যারেতে এই দিনের জন্য একটি এন্ট্রি রয়েছে।",
      errorInvalidJson: "'{lessonPath}' এ পাঠ ফাইলটিতে অবৈধ JSON রয়েছে। অনুগ্রহ করে সিনট্যাক্স ত্রুটির জন্য ফাইলটি পরীক্ষা করুন। ত্রুটি: {error}",
  ...
  Nepali: {
    scenario: {
      ...
      cancelStep3: "३. त्यहाँबाट तपाईं कुनै पनि समय रद्द करना सक्नुहुन्छ — तपाईंलाई अर्को बिलिङ चक्रको लागि शुल्क लिइने छैन।",
    },
    scenarioCard: {
