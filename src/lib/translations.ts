...
export const translations = {
  English: {
    ...
    pricingTitle: "Flexible Plans for Every Learner",
    pricingSub: "Start free, then choose a plan that fits your journey.",
    freePlan: {
      title: "Free",
      price: "$0",
    ...
    weeklyPlan: {
      ...
      price: "$4.99",
      per: "/week",
      desc: "Master one language. Renews weekly.",
  ...
  Sinhala: {
    ...
    pricingTitle: "සෑම ඉගෙන ගන්නෙකු සඳහාම නම්‍යශීලී සැලසුම්",
    pricingSub: "නොමිලේ ආරම්භ කරන්න, ඉන්පසු ඔබේ ගමනට ගැලපෙන සැලැස්මක් තෝරන්න.",
    freePlan: {
      title: "නොමිලේ",
      price: "$0",
      description: "අපගේ ඉගෙනුම් ක්‍රමයේ රසයක් ලබා ගන්න.",
    ...
    weeklyPlan: {
      ...
      price: "$4.99",
      per: "/සතියකට",
      desc: "එක් භාෂාවක් ප්‍රගුණ කරන්න. සතිපතා අලුත් වේ.",
  ...
  Hindi: {
    ...
    weeklyPlan: {
      ...
      price: "$4.99",
      per: "/सप्ताह",
      desc: "एक भाषा में महारत हासिल करें। साप्ताहिक नवीनीकरण।",
  ...
  Urdu: {
    ...
    pricingTitle: "ہر سیکھنے والے کے لیے لچکدار منصوبے۔",
    pricingSub: "مفت شروع کریں۔ پھر اپنے سفر کے مطابق منصوبہ منتخب کریں۔",
    freePlan: {
      title: "مفت",
      price: "$0",
    ...
    weeklyPlan: {
      ...
      price: "$4.99",
      per: "/ہفتہ",
      desc: "ایک زبان میں مہارت حاصل کریں۔ ہفتہ وار تجدید ہوتی ہے۔",
  ...
  Bengali: {
    ...
    pricingTitle: "প্রতিটি শিক্ষার্থীর জন্য নমনীয় পরিকল্পনা।",
    pricingSub: "বিনামূল্যে শুরু করুন। তারপর আপনার যাত্রার জন্য উপযুক্ত একটি পরিকল্পনা চয়ন করুন।",
    freePlan: {
      title: "বিনামূল্যে",
      price: "$0",
    ...
    weeklyPlan: {
      ...
      price: "$4.99",
      per: "/সপ্তাহ",
      desc: "একটি ভাষায় দক্ষতা অর্জন করুন। সাপ্তাহিক পুনর্নবীকরণ হয়।",
  ...
  Nepali: {
    ...
    pricingTitle: "प्रत्येक शिक्षार्थीको लागि लचिलो योजनाहरू।",
    pricingSub: "नि:शुल्क सुरु गर्नुहोस्। त्यसपछि आफ्नो यात्रामा फिट हुने योजना छान्नुहोस्।",
    freePlan: {
      title: "नि:शुल्क",
      price: "$0",
    ...
    weeklyPlan: {
      ...
      price: "$4.99",
      per: "/हप्ता",
      desc: "एक भाषामा महारत हासिल गर्नुहोस्। साप्ताहिक नवीकरण हुन्छ।",
