...
// Language Constants must be at the top to prevent initialization ReferenceErrors
...
export const translations = {
  ...
  Urdu: {
    ...
    pricingSub: "آپ کے مفت ٹرائل میں بقا کے راستے کا ہفتہ 1 شامل ہے۔ تمام اسباق کو غیر مقفل करने के لیے اپ گریڈ کریں۔",
    pricingPage: {
    ...
    dashboard: {
      ...
      reminders: {
        ...
        permissionNeeded: "یاد دہانیاں فعال کرنے کے لیے اطلاع کی اجازت درکار ہے۔",
        grantPermission: "اجازت دیں",
        save: "یاد دہانی محفوظ کریں",
        saved: "یاد دہانی کی ترتیبات محفوظ ہو گئیں!",
      },
       referrals: {
    ...
    ui: {
      ...
      lessonsLocked: "اس ہفتے के اسباق مقفل ہیں۔",
      upgradeToUnlock: "انلاک کرنے کے لیے اپ گریڈ کریں۔",
      // lesson page errors
      errorTitle: "سبق لوڈ نہیں ہو سکا",
      errorWeekNotFound: "{path} راستے के ہفتہ {week} کے لئے سبق का مواد موجود نہیں ہے۔ براہ کرم 'public{lessonPath}' پر فائل بنائیں۔",
      ...
      errorGeneric: "سبق की فائل لوڈ کرنے میں ناکام। حیثیت: {status}",
      errorInvalidDay: 'غلط دن का پیرامیٹر: "{day}"। ایک نمبر ہونا چاہئے۔',
      backToDashboard: "ڈیش بورڈ پر واپس",
      contentNotAvailableTitle: "مواد دستیاب نہیں ہے",
      contentNotAvailableDesc: "یہ سبق ابھی تک نہیں बनाया گیا ہے۔ آپ `public/lessons` ڈائرکٹری میں سبق की فائل بنا سکتے ہیں۔ ہدایات के لئے براہ کرم `docs/lesson-generation-guide.md` देखیں۔",
      // lesson client page
      weekProgress: "ہفتے की پیشرفت",
  ...
  Bengali: {
    scenario: {
      ...
      lockedFeature2: "Daily AI voice conversation practice",
      lockedFeature3: "Generate as many new scenario plans as you like (monthly subscription)",
      subscribeButton: "Subscribe — $13/মাস",
    ...
    path3Title: "Numbers Path",
    path3Desc: "প্রতিদিন টাকা, সময় এবং সংখ্যা আত্মবিশ্বাসের साथ সামলান।",
    ...
    pricingSub: "আপনার বিনামূল্যে ট্রায়ালে বেঁচে থাকার পথের सप्ताह 1 অন্তর্ভুক্ত। সমস্ত পাঠ আনলক করতে আপগ্রেড করুন।",
    pricingPage: {
    ...
    ui: {
      ...
      errorGeneric: "পাঠ ফাইল লোڈ করতে ব্যর্থ হয়েছে। স্থিতি: {status}",
  ...
  Nepali: {
    scenario: {
      ...
      lockedFeature2: "Daily AI voice conversation practice",
      lockedFeature3: "Generate as many new scenario plans as you like (monthly subscription)",
      subscribeButton: "Subscribe — $13/महिना",
    ...
    poster: {
        ...
        subtitle: "दैनिक जीवनका लागि • काम के लागि",
        tagline: "unfold your opportunities"
    },
    ...
    features: {
      ...
      exercises: { title: "दैनिक अभ्यासहरू", desc: "खानी ठाउँ भर्नुहोस्, MCQ, शब्द मिलान खेलहरू" },
